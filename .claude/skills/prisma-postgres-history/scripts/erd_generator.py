#!/usr/bin/env python3
"""Source: borghei/Claude-Skills, engineering/database-schema-designer/scripts/erd_generator.py
License: MIT + Commons Clause. Copied unmodified as a standalone stdlib-only utility.
