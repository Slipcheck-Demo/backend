#!/usr/bin/env python3
# Source: naodeng/awesome-qa-skills, skills/en/testing-types/api-test-supertest/scripts
# License: PolyForm Noncommercial 1.0.0 — see ../SKILL.md for the commercial-use caveat.
import argparse
import json
import re
